...
CHROME_DEST="node_modules/chrome/${CFT_PLATFORM}-${VERSION}"
...
DRIVER_DEST="node_modules/chromedriver113"
...
ln -sf "../../${CHROME_BIN}" "$BIN_DIR/chrome113"
ln -sf "../../${CHROMEDRIVER_BIN}" "$BIN_DIR/chromedriver113"
