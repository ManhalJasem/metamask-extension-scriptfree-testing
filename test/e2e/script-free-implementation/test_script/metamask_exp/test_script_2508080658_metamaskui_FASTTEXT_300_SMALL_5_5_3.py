...
# beam width: 5
# text weight: 3
# model load time: 34.10506272315979
# generation time: 240.03764653205872
...
def show_qr_code(driver):
    ...
    driver.save_screenshot('test_script/metamask_exp/screenshots/open_20250808_065630.png')
    driver.find_element(By.ID,'password').clear()
    driver.find_element(By.ID,'password').send_keys('correct horse battery staple')
    driver.save_screenshot('test_script/metamask_exp/screenshots/enter_20250808_065630.png')
    driver.find_element(By.XPATH,'/html/body/div/div/div[4]/div/div/button').click()
    driver.save_screenshot('test_script/metamask_exp/screenshots/click_20250808_065630.png')
    ...
    driver.save_screenshot('test_script/metamask_exp/screenshots/assert_element_20250808_065630.png')
    driver.execute_script("""document.querySelector('.account-modal-close').click()""")
    driver.save_screenshot('test_script/metamask_exp/screenshots/execute_script_20250808_065630.png')
...
def add_account(driver):
    driver.get('chrome-extension://fochammdjkalfjmglakiadgeeipdajka/home.html#')
    driver.implicitly_wait(10)
    driver.save_screenshot('test_script/metamask_exp/screenshots/open_20250808_065836.png')
    driver.find_element(By.ID,'password').clear()
    driver.find_element(By.ID,'password').send_keys('correct horse battery staple')
    driver.save_screenshot('test_script/metamask_exp/screenshots/enter_20250808_065836.png')
    driver.find_element(By.XPATH,'/html/body/div/div/div[4]/div/div/button').click()
    driver.save_screenshot('test_script/metamask_exp/screenshots/click_20250808_065836.png')
    assert driver.find_element(By.XPATH,'/html/body/div/div/div[4]/div/div/div[1]/div[1]/div[1]/div[3]/button').is_displayed()
    driver.save_screenshot('test_script/metamask_exp/screenshots/assert_element_20250808_065836.png')
    ...
    driver.save_screenshot('test_script/metamask_exp/screenshots/execute_script_20250808_065836.png')
